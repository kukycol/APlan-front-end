<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      ...
      <el-select v-model="listQuery.isSystem" placeholder="系统参数" clearable style="width: 110px" class="filter-item">
    ...
    >
      ...
      <el-table-column label="参数键名" align="center">
        <template slot-scope="{row}">
          <span>{{ row.paramKey }}</span>
        </template>
      </el-table-column>
      <el-table-column label="参数键值" align="center" width="110" :show-overflow-tooltip="true">
        <template slot-scope="{row}">
          <span>{{ row.paramValue }}</span>
        </template>
      </el-table-column>
      <el-table-column label="参数备注" align="center" width="110" :show-overflow-tooltip="true">
        <template slot-scope="{row}">
          <span>{{ row.paramRemark }}</span>
        </template>
      </el-table-column>
      <el-table-column label="系统参数" align="center" width="110" :show-overflow-tooltip="true">
        <template slot-scope="{row}">
    ...
    <el-dialog :title="textMap[dialogStatus]" :visible.sync="dialogFormVisible">
      <el-form ref="dataForm" :rules="rules" :model="temp" label-position="left" label-width="100px" style="width: 400px; margin-left:50px;">
        ...
        <el-form-item label="参数键值" prop="paramValue">
          <el-input v-model="temp.paramValue" :autosize="{ minRows: 4, maxRows: 6}" type="textarea" placeholder="Please input" />
        </el-form-item>
        <el-form-item label="参数备注" prop="paramRemark">
          <el-input v-model="temp.paramRemark" :autosize="{ minRows: 4, maxRows: 6}" type="textarea" placeholder="Please input" />
        </el-form-item>
        <el-form-item label="系统参数" prop="isSystem">
          <el-radio-group v-model="temp.isSystem" size="small">
...
<script>
import { pageParam, delParam, btcParam, createParam, updateParam } from '@/api/param-table'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      pageParam(this.listQuery).then(response => {
    ...
    createData() {
      this.$refs['dataForm'].validate((valid) => {
        if (valid) {
          createParam(this.temp).then((res) => {
            if (res.code === 20000) {
              // 显示表单提示按钮
